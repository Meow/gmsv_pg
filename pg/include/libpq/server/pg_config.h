...
#define PACKAGE_STRING "PostgreSQL 9.5beta1"
...
#define PG_VERSION_STR "PostgreSQL 9.5beta1, compiled by Visual C++ build " __STRINGIFY2(_MSC_VER) ", 32-bit"
